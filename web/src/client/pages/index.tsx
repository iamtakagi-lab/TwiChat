  ...
  return (
    <Layout>
      ...
      <section id="talk_others_section">
        ...
        {isError ? <div style={{color: "red", fontSize: ".8rem"}}>{errorMessage}</div> : null}
        <form
          onSubmit={(e) => {
            tryOpenChat(e);
          }}
      ...
      <section id="how_to_use_section">
        ...
        <section className="how_to_use_description">
          ...
          <p>
            「ツイッターでログイン」ボタンを押します。<br/>
            あなたのツイートを学習したもうひとりの自分と<br/>
            チャットができます。
          </p>
        </section>
        <section className="how_to_use_description">
          ...
          <p>
            「アカウント名を入力してね」欄に ツイッターID を入力、「他ユーザーの分身と話してみる」ボタンを押します。他ユーザーのツイートを学習した分身とチャットができます。
          </p>
        </section>
      </section>
