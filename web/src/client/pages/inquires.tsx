...
export const Inquires = () => (
  <Layout>
    <section id="inquires_section">
      <h2>お問い合わせ</h2>
      <p id="inquires">
        公式アカウント{" "}<img src="./twichat_app.jpg" alt="" width={"30px"} height={"30px"} />{" "}<a href="https://twitter.com/twichat_app">@twichat_app</a>
      </p>
      <br />
      <p>
    ...
    <footer id="footer">
      ...
      <div id="footer_accounts">
        <p className="footer_account">
          公式アカウント:{" "}
          <img src="./images/twichat_app.jpg" alt="" width={"30px"} height={"30px"} />{" "}
